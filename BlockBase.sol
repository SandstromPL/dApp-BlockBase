...
contract ExpenseTracker {
    ...
    // Emitted when a person's name is updated
    event PersonUpdated(address indexed walletAddress, string name);
    ...
    // to update username... // solidity task
    /**
     * @dev Update the name of a registered person
    ...
    // solidity function to get the total number of registered users
